...
public class BankApp {
	...
	public static void main(String args[]) throws ApplicationException
	{
		...
		do {
			...
			choice=sc.nextByte();
			switch(choice) {
		case 1:List<Customer> customerList =customerService.registerCustomer();
				if(!customerList.isEmpty()){
					System.out.println("Customer registered successfully");
					customerDisplay(customerList);
				}
				break;
		case 2:List<Account> accountList2 =accountService.createAccount();
		...
		case 3: System.out.println("Enter account id:");
				...
				Double Updatedbalance=accountService.updateAccountBalance(account_Id,balance);
		...
		case 4:	System.out.println("Enter account id:");
				...
				accountService.deactivateAccount(account_Id1);
		...
		case 5:System.out.println("Enter customer id:");
				...
				customerService.unregisterCustomer(customer_Id3); 
